...
var GifForm = React.createClass({
	...
	getInitialState: function() {
		...
		if(this.props.gif){
			...
			gif = {
				link: this.convertLinkToGif(Utils.getImageFromUrl()),
	...
	renderLink : function(){
		if(this.state.gif.id){
			return [
				...
				<ClipboardButton link={this.state.gif.link} tooltip={null}/>
			];
		}else{
	...
	renderSaveButton : function(){
		...
		return (
			<button className={cx('save', {'add' : !isEditMode, 'update' : isEditMode})} disabled={!this.isValid()} onClick={this.handleSave}>
				<i className={cx('fa', {
	...
	render : function(){
		...
		var imageContainer = <div
			className={cx('imageContainer', {filler : !gif.link})}
			style={{backgroundImage : "url('" + (gif.link ? gif.link : randomBucketImg) + "')" }} />
		...
		return(
			<div className='gifForm'>
				...
				<div className='dataSide'>
					...
					<div className='user formItem'>
						{this.renderUser()}
					</div>

					<div className='control formItem'>
